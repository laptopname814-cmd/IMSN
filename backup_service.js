...
const IGNORE_NAMES = new Set(['backups', 'node_modules', '.git', '.vscode', '__pycache__', '.gitignore']);
...
async function backupProject() {
  try {
    ...
    await copyDirectory(projectRoot, target);
...
async function runBackupLoop() {
  console.log('⏰ Automatic backup service started. Backups every 1 hour.');
...
module.exports = { startBackupLoop: () => runBackupLoop(), manualBackup };
